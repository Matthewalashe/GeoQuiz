...
(async function seedP3() {
  ...
  // ═══════════════════════════════════════
  const coloring = [
    { scene_id:'danfo', title:'🚐 Danfo Bus', description:'Color the iconic Lagos yellow bus', color:'#fde047', min_parts:4, parts:['body','bumper','window1','window2','window3','stripe','wheel1','wheel2','headlight'], guide:{body:'#fde047',bumper:'#1e293b',window1:'#64748b',window2:'#64748b',window3:'#64748b',stripe:'#1e293b',wheel1:'#1e293b',wheel2:'#1e293b',headlight:'#fde047'}, svg_key:'danfo', sort_order:-3 },
    { scene_id:'market', title:'🏪 Lagos Market', description:'Bring a market scene to life with color', color:'#f97316', min_parts:3, parts:['stall1','stall2','stall3','roof1','roof2','roof3','ground','goods'], guide:{stall1:'#ef4444',stall2:'#3b82f6',stall3:'#22c55e',roof1:'#a16207',roof2:'#a16207',roof3:'#a16207',ground:'#64748b',goods:'#fde047'}, svg_key:'market', sort_order:-2 },
    { scene_id:'house', title:'🏠 Lagos Bungalow', description:'Paint a classic Nigerian compound house', color:'#22c55e', min_parts:4, parts:['wall','roof','door','window1','window2','path','sky','grass'], guide:{wall:'#fde047',roof:'#ef4444',door:'#a16207',window1:'#64748b',window2:'#64748b',path:'#d4a574',sky:'#3b82f6',grass:'#22c55e'}, svg_key:'house', sort_order:-1 },
